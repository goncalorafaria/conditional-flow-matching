...
class UNetModelGuided(nn.Module):
    ...
    def __init__(
        ...
        if self.zdim is not None:
            self.label_emb = nn.Linear(self.zdim, time_embed_dim)
    ...
    def forward(self, t, x, y=None):
        ...
        if self.zdim is not None:
            assert y.shape == (x.shape[0],self.zdim)
...
class UNetModelGuidedWrapper(UNetModelGuided):
    def __init__(
        self,
        dim,
        num_channels,
        ...
        return super().__init__(
            ...
            zdim=(zdim if class_cond else None),
            use_checkpoint=use_checkpoint,
            use_fp16=use_fp16,
            num_heads=num_heads,
            num_head_channels=num_head_channels,
